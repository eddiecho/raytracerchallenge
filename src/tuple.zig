...
pub const Tuple = struct {
    ...
    pub fn add(self: *const Tuple, other: *const Tuple) Tuple {
        ...
        return Tuple.init(self.x + other.x, self.y + other.y, self.z + other.z, self.w + other.w);
    }
    ...
    pub fn cross(self: *const Tuple, other: *const Tuple) Tuple {
        ...
        return Tuple.vector((self.y * other.z) - (self.z * other.y), (self.z * other.x) - (self.x * other.z), (self.x * other.y) - (self.y * other.x));
    }
